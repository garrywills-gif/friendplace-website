...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[0]['changeFrequency'] }[] = [
    ...
    { path: '/guides/how-to-make-friends-over-50-australia', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/guides/how-to-make-friends-after-retirement', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/guides/where-can-i-meet-people-near-me', priority: 0.8, changeFrequency: 'monthly' },
