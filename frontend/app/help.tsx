...
const FAQ = [
  ...
  { q: "What are Belong Points?", a: "You earn Belong Points for taking part — chatting, posting, playing games. They unlock fun badges to show off on your profile." },
  ...
  { q: "How do daily challenges work?", a: "Open Games Hub each day. Daily Trivia, Daily Bingo and Daily Jigsaw give bonus Belong Points and feed your daily streak." },
];
